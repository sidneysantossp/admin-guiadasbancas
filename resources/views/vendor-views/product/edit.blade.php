                            ...
                            <div class="row g-2">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" name="available_time_starts" class="form-control" id="available_time_starts" value="{{ $product['available_time_starts'] }}" placeholder="{{ translate('messages.Ex :') }} 10:30 am">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.available_time_ends') }}</label>
                                        <input type="time" name="available_time_ends" class="form-control" value="{{ $product['available_time_ends'] }}" id="available_time_ends" placeholder="5:45 pm">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('script_2')
    <script>
        ...
        $('#category-id').on('change', function() {
            ...
            if (category_id) {
                getRequest('{{url('/')}}/banca/produto/get-categories?parent_id=' + category_id, 'sub-categories');
            }
        });
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                if (category) {
                    getRequest('{{url('/')}}/banca/produto/get-categories?parent_id=' + category + '&sub_category=' + sub_category, 'sub-categories');
                }
            }, 1000);
        });
    </script>
