...
if (isset($cart['paid'])) {
    $paid = $cart['paid'];
    $change = $total +  $tax_amount + $additional_charge - $paid;
} else {
    $paid = $total + $tax_amount + $additional_charge;
    $change = 0;
}
?>
...
{{--            @endif--}}
            ...
            <dd class="col-6 text-right h4 b"> {{Helpers::format_currency(round($total+ $additional_charge + $tax_amount, 2))}} </dd>
        </dl>
