                                            ...
                                            data-original-title="{{ translate('messages.Required.')}}"> *
                                             ...
                                             @foreach ($categories as $category)
                                                 <option value="{{ $category['id'] }}"
                                                        {{ (isset($product_category) && !empty($product_category) && isset($product_category[0]) && isset($product_category[0]->id) && ($category->id == $product_category[0]->id)) ? 'selected' : '' }}>
                                        ...
                                        <label class="input-label"
                                            for="exampleFormControlSelect1">{{ translate('messages.sub_category') }}<span
                                                ...
                                                data-original-title="{{ translate('messages.category_required_warning') }}"><img
                                                    ...
                                                    data-id="{{ (isset($product_category) && is_iterable($product_category) && count($product_category) >= 2 && isset($product_category[1]) && isset($product_category[1]->id)) ? $product_category[1]->id : '' }}"
                                ...
                                @if ($productWiseTax)
                                    <div class="col-md-3">
                                        <div class="form-group pickup-zone-tag mb-0">
                                            <label class="input-label"
                                                for="exampleFormtax">{{ translate('Select Tax Rate') }}
                                            </label>
                                            <select name="tax_ids[]" id="tax__rate" class="form-control multiple-select2" multiple="multiple" placeholder="{{translate('--Select Tax Rate--')}}">
