        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-right flex-grow-1">
                ...
                <ul class="navbar-nav align-items-center flex-row justify-content-end">
                    ...
                    <li class="nav-item max-sm-m-0 w-md-200px d-none">
                    ...
                    <!-- Distributor Cart -->
                    <li class="nav-item mr-2 mr-sm-3 mr-md-4">
                        <!-- Notification -->
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon navbar--cart btn-soft-secondary rounded-circle"
                               href="{{ route('vendor.distributor-products.cart') }}">
                                <i class="tio-shopping-cart-outlined"></i>
                                <span class="badge badge-soft-primary position-absolute" id="header-distributor-cart-count" style="top:-6px;right:-6px;">0</span>
                            </a>
                        </div>
                        <!-- End Notification -->
                    </li>
                    <!-- End Distributor Cart -->
...
<script>
    $(document).ready(function(){
        if (typeof updateCartCount === 'function') {
            ...
            // Fallback fetch only for header if page doesn't define updateCartCount
            $.get("{{ url('/') }}{{ route('vendor.distributor-products.cart-count', [], false) }}").done(function(data){
                $('#header-distributor-cart-count').text(data.cart_count || 0);
            });
        }
    });
</script>
