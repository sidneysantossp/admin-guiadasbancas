        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content text-capitalize bg-334257">
                <ul class="navbar-nav navbar-nav-lg nav-tabs mt-3">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('banca')?'active':''}}">
                    ...
                    @if(\App\CentralLogics\Helpers::employee_module_permission_check('pos'))
                        <!-- POS -->
                        <li class="navbar-vertical-aside-has-menu {{Request::is('banca/pos')?'active':''}}">
                    ...
                    <!-- Distributor Section -->
                    <li class="nav-item">
                        <small class="nav-subtitle">{{ translate('Distribuidores') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>

                    <li class="navbar-vertical-aside-has-menu {{ request()->routeIs('vendor.food.catalog-distributors') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('vendor.food.catalog-distributors') }}" title="{{ translate('Catálogo de Distribuidores') }}">
                            <i class="tio-shop nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('Catálogo de Distribuidores') }}</span>
                        </a>
                    </li>

                    <li class="navbar-vertical-aside-has-menu {{ request()->routeIs('vendor.distributor-orders.*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('vendor.distributor-orders.index') }}" title="{{ translate('Meus Pedidos (Distribuidores)') }}">
                            <i class="tio-receipt nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('Meus Pedidos (Distribuidores)') }}</span>
                        </a>
                    </li>
                    ...
                    @if(\App\CentralLogics\Helpers::employee_module_permission_check('regular_order'))
                        <li class="navbar-vertical-aside-has-menu {{Request::is('banca/order*') && (Request::is('banca/order/subscription*') == false ) ?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: none">
                                <li class="nav-item {{Request::is('banca/order/list/all')?'active':''}} @yield('all_order') ">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/pending')?'active':'' }} @yield('pending')">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/confirmed')?'active':''}} @yield('confirmed') ">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/accepted')?'active':''}} @yield('accepted')">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/cooking')?'active':''}} @yield('processing')">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/ready_for_delivery')?'active':''}} @yield('handover')">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/food_on_the_way')?'active':''}} @yield('picked_up')">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/delivered')?'active':''}} @yield('delivered')">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/dine_in')?'active':''}} @yield('dine_in')">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/refunded')?'active':''}} @yield('refunded')">
                                ...
                                <li class="nav-item {{Request::is('banca/order/list/refund_requested')?'active':''}} @yield('refund_requested')">
