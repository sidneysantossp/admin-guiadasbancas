...
<head>
    ...
    <!-- Custom CSS para sidebar sempre aberto -->
    <link rel="stylesheet" href="{{ dynamicAsset('public/assets/admin/css/custom-sidebar.css') }}">
    @stack('css_or_js')
...
"use strict";
    ...
    <!-- Custom JavaScript para sidebar sempre aberto -->
    <script src="{{ dynamicAsset('public/assets/admin/js/custom-sidebar.js') }}"></script>
