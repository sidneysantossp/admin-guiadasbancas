...
class Vendor extends Authenticatable
{
    ...
    /**
     * Produtos disponibilizados pelo distribuidor para jornaleiros
     */
    public function distributorProducts()
    {
        return $this->hasMany(DistributorVendorProduct::class, 'distributor_id');
    }

    /**
     * Produtos disponíveis para este jornaleiro de distribuidores
     */
    public function availableDistributorProducts()
    {
        return $this->hasMany(DistributorVendorProduct::class, 'vendor_id');
    }

    /**
     * Pedidos feitos como distribuidor
     */
    public function distributorOrders()
    {
        return $this->hasMany(DistributorOrder::class, 'distributor_id');
    }

    /**
     * Pedidos feitos como jornaleiro para distribuidores
     */
    public function vendorOrders()
    {
        return $this->hasMany(DistributorOrder::class, 'vendor_id');
    }

    /**
     * Verifica se é um distribuidor
     */
    public function isDistributor()
    {
        return $this->distributor == 1;
    }

    /**
     * Verifica se é um jornaleiro
     */
